...
setenv start_emmc_autoscript 'if ext4load mmc 1 0x08000000 /boot/emmc_autoscript; then autoscr 0x08000000;else if fat4load mmc 1 0x08000000 emmc_autoscript; then autoscr 0x08000000;else echo "load emmc_autoscript failed";fi;fi;'
...
if ext4load usb 0 0x01000000 /boot/u-boot.bin; then
    go 0x01000000
else
    if fatload usb 0 0x01000000 u-boot.bin; then
        go 0x01000000
    else
